...
##'
##' @param orderObject An object of class \code{orderObject} that 
##' contains the processed data and the ordering.
...
plotSequence <- function(orderObject, plotFAST=TRUE,
    ...
    plot2 <- round((ncol(inputHCGFix)+blankWidth)/ncol(toPlotFix), 2)
