        ...
        navbarPage("",
                ...
                sidebarLayout(
                    sidebarPanel(
                        fileInput("gch_seq_file", 
                            label="GCH Sequence RDS file"),
                        fileInput("hcg_seq_file", 
                            label="HCG Sequence RDS file"),
                        numericInput("startPos", label="Starting position", 
                            value=0, min=1),
                        numericInput("endPos", label="Ending position", 
                            value=0, min=1),
                        ...
                        radioButtons("sc_brush_choice", label="Brushing for:",
                            choices=c("Refinement", "Weighting"), 
                            selected="Weighting"),
                        actionButton("sc_force_reverse", 
                            label="Force Reverse"),
                        ...
                        mainPanel(
                            fluidRow(column(width=8,
                                ...
                                column(width=2, align='left',
                                    selectInput("sc_plot_filetype", 
                                    label="File type", 
                                    choices=c("PNG", "SVG", "PDF")),
                                    downloadButton("sc_plot_down", 
            ...
            tabPanel("Summary Statistics",
                radioButtons("sc_proportion_choice", label="Proportion of:",
                    choices=c("Yellow", "Red"), selected="Yellow"),
                splitLayout(cellWidths=c("50%", "50%"),
                    plotOutput(outputId="sc_proportion_color_histogram"),
                    plotOutput(outputId="sc_percent_C")),
                splitLayout(cellWidths=c("50%", "50%"),
                    downloadButton("sc_proportion_hist_download",
                        label="Download histogram"),
                    downloadButton("sc_percentC_plot_download", 
                        label="Download plot")),
                splitLayout(cellWidths=c("50%", "50%"),
                    downloadButton("sc_proportion_data_download",
                        label="Download proportion data"),
                    downloadButton("sc_percentC_data_download", 
                        label="Download percentage data"))))),
        ...
        navbarPage("",
            tabPanel("Preprocessing",
                ...
                textInput("processing.log.name", 
                    label="Processing Log File Name"),
                ...
                sidebarLayout(
                    ...
                    mainPanel(
                        fluidRow(column(width=8,
                            ...
                            column(width=2, align='left',
                                selectInput("sm_filetype", label="File type",
                                    choices=c("PNG", "SVG", "PDF")),
                                downloadButton("sm_plot_down",
                                    label="Download the plot"),
                                downloadButton("sm_log_down", 
                                    label="Download changes log"))
            ...
            tabPanel("Summary Statistics",
                radioButtons("sm_proportion_choice", label="Proportion of:",
                    choices=c("Yellow", "Red"), selected="Yellow"),
                splitLayout(cellWidths=c("50%", "50%"),
                    plotOutput(outputId="sm_proportion_color_histogram"),
                    plotOutput(outputId="sm_percent_C")),
                splitLayout(cellWidths=c("50%", "50%"),
                    downloadButton("sm_proportion_hist_download", 
                        label="Download histogram"),
                    downloadButton("sm_percentC_plot_download", 
                        label="Download plot")),
                splitLayout(cellWidths=c("50%", "50%"),
                    downloadButton("sm_proportion_data_download", 
                        label="Download proportion data"),
                    downloadButton("sm_percentC_data_download", 
                        label="Download percentage data"))))))